      ...
      if (query.contains("twinkle") || query.contains("rhyme") || query.contains("johny") || query.contains("humpty")) {
        if (isHindi) {
          aiResponse = "बच्चों के लिए प्रसिद्ध बाल कविताएं (Nursery Rhymes) 🎵:\n\n"
              ...
              "💡 **आसान स्पष्टीकरण**: ये कविताएँ छोटे बच्चों को अक्षरों की आवाज़, मज़ा और याद रखने की कला सिखाती हैं। इन्हें संगीत के साथ सुनने के लिए होम स्क्रीन पर 'Play Study' सेक्शन देखें!";
        } else {
        ...
        if (isHindi) {
          aiResponse = "भूगोल क्या है? (Geography Made Easy) 🌍:\n\n"
              ...
              "   - **भूपर्पटी (Crust)**: पृथ्वी की सबसे ऊपरी परत जहाँ हम पैर रखते हैं और पेड़-पौधे उगते हैं।\n"
        ...
        if (isHindi) {
          aiResponse = "एमएस एक्सेल फ़ॉर्मूला (Excel Formulas Made Easy) 📊:\n\n"
              "1️⃣ **मूल फ़ॉर्मूले**:\n"
        ...
        if (isHindi) {
          aiResponse = "एमएस पावरपॉइंट प्रेजेंटेशन (PowerPoint Made Easy) 📉:\n\n"
              ...
              "   - **आसान शब्दों में**: यदि आपके पास 50 स्लाइड्स हैं और आप चाहते हैं कि हर स्लाइड के कोने में स्कूल का लोगो दिखाई दे, तो 50 बार लोगो लगाने के बजाय स्लाइड मास्टर में लगाएं। यह अपने आप सब पर लग जाएगा।\n"
              "   - **करने के तरीके**:\n"
              "     1. **View** टैब पर जाएं ➔ **Slide Master** पर क्लिक करें।\n"
              "     2. सबसे ऊपर वाली पहली स्लाइड को चुनें और वहाँ लोगो लगाएं।\n"
              "     3. **Close Master View** पर क्लिक करें। सभी स्लाइड्स का डिज़ाइन एक साथ बदल जाएगा!\n\n"
        ...
        if (isHindi) {
          aiResponse = "इंटरनेट और कंप्यूटर नेटवर्क (Internet & Networks Made Easy) 🌐:\n\n"
              "1️⃣ **आईपी एड्रेस (IP Address - पहचान पता)**:\n"
              "   - जैसे डाक भेजने के लिए हमारे घर का पता होता है, वैसे ही इंटरनेट पर हर कंप्यूटर का अपना एक खास नंबर (पता) होता है जिसे IP एड्रेस कहते हैं।\n"
              "   - **उदाहरण**: 192.168.1.1\n\n"
              "2️⃣ **डीएनएस (DNS - इंटरनेट की गाइड बुक)**:\n"
              "   - जब हम इंटरनेट पर 'google.com' टाइप करते हैं, तो कंप्यूटर इसे नहीं समझता। DNS का काम 'google.com' नाम को उसके वास्तविक आईपी पते में बदलना है, ताकि वेबसाइट खुल सके।\n\n"
              "3️⃣ **प्रोटोकॉल (Rules)**:\n"
              "   - प्रोटोकॉल का मतलब है इंटरनेट पर डेटा भेजने के नियम।\n"
              "   - **HTTP / HTTPS**: वेबसाइट खोलने के नियम। (HTTPS सुरक्षित होता है)।\n"
              "   - **SMTP**: ईमेल भेजने के नियम।";
        } else {
          aiResponse = "Internet and Networks Made Super Simple 🌐:\n\n"
              "1️⃣ **IP Address (Computer's Home Address)**:\n"
              "   - Just like your house has a street address to receive mail, every computer on the internet has a unique number code called an IP Address.\n"
              "   - **Example**: `192.168.1.50`\n\n"
              "2️⃣ **DNS (The Internet Phonebook)**:\n"
              "   - Computers don't understand words like `google.com`. The Domain Name System (DNS) translates `google.com` into its IP number so your computer can connect to it.\n\n"
              "3️⃣ **Protocols (Internet Rules)**:\n"
              "   - Rules that decide how data travels safely.\n"
              "   - **HTTP / HTTPS**: Rules to download website pages. (S = Secure).\n"
              "   - **SMTP**: Rules used to send email messages.";
        }
